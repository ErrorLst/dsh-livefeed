...
`;
    ...
    async function rpc(method, args) {
      ...
      if (!json || json.ok !== true) throw new Error(json && json.error ? json.error : 'rpc failed: ' + method);
      return json.data;
    }
    ...
    function SettingsView(props) {
      ...
      React.useEffect(() => {
        (async () => {
          ...
          } catch (e) { setLoadError('模型目录加载失败：' + String((e && e.message) || e)); }
          try {
